...
final class CartItemsProvider
    extends $NotifierProvider<CartItems, List<BookModel>> {
  CartItemsProvider._()
    : super(
        from: null,
        argument: null,
  ...
  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(List<BookModel> value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<List<BookModel>>(value),
    );
  }
}

String _$cartItemsHash() => r'37a22b06d4aa02aaa903561e56b1fa9832711bf9';

abstract class _$CartItems extends $Notifier<List<BookModel>> {
  List<BookModel> build();
  @$mustCallSuper
  @override
  void runBuild() {
    final ref = this.ref as $Ref<List<BookModel>, List<BookModel>>;
    final element =
        ref.element
            as $ClassProviderElement<
              AnyNotifier<List<BookModel>, List<BookModel>>,
              List<BookModel>,
              Object?,
              Object?
            >;
...
final class WishlistItemsProvider
    extends $NotifierProvider<WishlistItems, List<BookModel>> {
...
String _$wishlistItemsHash() => r'6e60327b337d02b4835981a6714307ebc81fda17';

abstract class _$WishlistItems extends $Notifier<List<BookModel>> {
  List<BookModel> build();
  @$mustCallSuper
  @override
  void runBuild() {
